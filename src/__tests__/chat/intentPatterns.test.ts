...
const CASES: [string, string][] = [
  ...
  ['What are my top 5 most-seen bands?', 'top5_artists'],
  ["Who's the artist I've seen the most?", 'top_artist'],
  ["Who's the band I've seen the most?", 'top_artist'],
  ["Who's the artist I've seen the most, other than Foo Fighters?", 'top_artist'],
  ['Which artists have I seen the most?', 'top_artist'],
  ['Which bands have I seen the most?', 'top_artist'],
  ['Which bands have I seen the most, other than Foo Fighters?', 'top_artist'],
  ['Which is the artist that I’ve seen the most in a single year?', 'top_artist_in_a_single_year'],
  ['Which band have I seen the most in a single year?', 'top_artist_in_a_single_year'],
  ['How many unique artists have I seen overall?', 'unique_artists_count'],
  ['How many unique bands have I seen overall?', 'unique_artists_count'],
  ['How many artists have I seen more than once?', 'artists_seen_more_than_once'],
  ['How many bands have I seen more than once?', 'artists_seen_more_than_once'],
  ['How many artists have I only seen a single time?', 'artists_seen_only_once'],
  ['How many bands have I only seen a single time?', 'artists_seen_only_once'],
  ['Which artists have I seen 5 or more times?', 'artists_seen_at_least_n'],
  ['Which bands have I seen 5 or more times?', 'artists_seen_at_least_n'],
  ...
  ['How many times have I been to The Fillmore?', 'venue_visit_count'],
  ['How many times have I visited The Fillmore?', 'venue_visit_count'],
  ['Which artists have I seen at Red Rocks?', 'bands_seen_at_venue'],
  ['When was the first time I was at The Fillmore?', 'first_time_at_venue'],
  ['When was the first time I visited The Fillmore?', 'first_time_at_venue'],
  ['When was the last time I went to Red Rocks?', 'last_time_at_venue'],
  ['How many different venues have I been to?', 'venues_seen_count'],
  ['How many different venues have I visited?', 'venues_seen_count'],
  ['Which venue have I been to the most?', 'most_visited_venue'],
  ['Which venues have I visited the most?', 'most_visited_venue'],
  ['Which venue have I been to the most, other than Red Rocks?', 'most_visited_venue'],
  ['Which venues have I visited the most, other than Red Rocks?', 'most_visited_venue'],

  ['How many times has Bad Religion played American Jesus?', 'song_play_count'],
  ['Has Bad Religion ever played American Jesus?', 'song_play_count'],
  ['Did NOFX play Linoleum?', 'song_play_count'],
  ["What's Bad Religion's most played song?", 'most_played_song_by_artist'],
  ['What song does NOFX play the most?', 'most_played_song_by_artist'],
  ['What covers has Bad Religion played?', 'covers_played_by_artist'],
  ['Has NOFX played any covers?', 'covers_played_by_artist'],
  ['Which artists has Bad Religion brought on stage?', 'guest_artists_with'],
  ['Who has NOFX performed with?', 'guest_artists_with'],
];
